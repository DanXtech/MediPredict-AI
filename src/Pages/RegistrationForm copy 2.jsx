...
const RegistrationForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateStep(currentStep)) {
      console.log("Step is validated", currentStep);
      if (currentStep === totalSteps) { // Only navigate to the dashboard on the last step
        console.log("Form submission successful, navigating to Dashboard...");
        navigate("/dashboard", { state: { formData } }); // Pass formData via state to the dashboard
      }
    } else {
